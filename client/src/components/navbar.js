...
import HeadlinesContainer from '../containers/TopStoriesContainer';
  ...
  return(
    <Router>
      <div>
        ...
        <Route exact path="/channel" component={ChannelsContainer} />
        <Route exact path="/channel/:id" component={ChannelArticlesContainer} />
    </div>
    </Router>
  )
}
